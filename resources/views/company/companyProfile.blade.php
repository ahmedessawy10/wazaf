                ...
                <form action="" method="post" id="userForm" name="userForm">
                    ...
                    <div class="card-body  p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="{{ $user->phone }}" name="phone" id="phone" placeholder="Phone" class="form-control">
                        </div>
                    </div>
...
<script type="text/javascript">
    $("#userForm").submit(function (e) {
        ...
        $.ajax({
            type: "put",
            url: "{{ route('company.updateProfile') }}",
            ...
            success: function (response) {
                if(response.status == true){
                    ...
                    window.location.href="{{ route('company.copanyProfile') }}";
    ...
    $("#changePasswordForm").submit(function (e) {
        ...
        $.ajax({
            type: "post",
            url: "{{ route('company.changePassword') }}",
            ...
            success: function (response) {
                ...
                if(response.status == true){
                    ...
                    window.location.href = "{{ route('company.companyProfile') }}";
